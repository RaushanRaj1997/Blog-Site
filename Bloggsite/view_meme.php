  ...
  <div class="container">
   ...
   <section>
     <div class="container">
       <div class="row">
         <div class="col-md-6">
        <table class="table table-bordered table-script table-hover ">
      <thead>
      ...
      <tbody>
        <?php 
              ...
              while($result=mysqli_fetch_array($querydisplay)){
                ?>
                <tr>
                  <td><h1>Credit goes to :<?php echo $result['user'];  ?> </h1><br><h1 class="text-center bg-bright text-dark"><?php echo $result['comment']?> </h1><br><img src="<?php echo $result['meme_file'];?>" height="70%" width="100%">
                    <p class="text-bold"><?php echo $result['date'];?></p>
                  </td>
